...
<%
	//target => 검색 or id에 해당하는 music 찾기
...
%>
	...
	<div id="wrap" class="container">
			...
			<div class="col-10">
				<form method="get" action="/lesson02/quiz10_info.jsp">
					<div class="input-group col-6">
					  <input type="text" name="search" value="<%= search %>" class="form-control fs-20">
		...
		%>
			...
			<article class="pt-3">
				...
				<div class="d-flex border border-success p-3">
					<div>
						<img width="220" src="<%= target.get("thumbnail") %>">
					</div>
					<div class="ml-4">
						...
						<div class="text-secondary d-flex mt-3">
							...
							<div class="ml-4">
								...
								<div class="text-dark font-weight-bold"><%= (int)target.get("time") / 60 %> : <%= (int)target.get("time") % 60 %></div>
		...
		%>
			<article class="pt-3 border-top">
				<div class="pl-1">검색결과 없음</div>
			</article>
		<%
			}
		%>
